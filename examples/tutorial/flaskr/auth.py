...
def register():
    ...
    if request.method == "POST":
        ...
        if not username:
            ...
            error = "Se necesita la verificacion de la contraseña"
        ...
        if error is None:
            try:
                db.execute(
                    "INSERT INTO user (username, password,verificacion) VALUES (?, ?, ?)",
                    (username,generate_password_hash (password),verificacion),
                )
                db.commit()
